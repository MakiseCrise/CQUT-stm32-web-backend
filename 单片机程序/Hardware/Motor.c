...
{
	Motor1_SetSpeed(1,value);
	Motor2_SetSpeed(1,value);
	Motor3_SetSpeed(1,value);
	Motor4_SetSpeed(1,value);
}

void Car_Backward(int value)
{
	Motor1_SetSpeed(0,value);
	Motor2_SetSpeed(0,value);
	Motor3_SetSpeed(0,value);
	Motor4_SetSpeed(0,value);
}
...
void Car_TransForwardRight(int value){
	Motor1_SetSpeed(1,0);//1轮
	Motor2_SetSpeed(1,value);//2轮
	Motor3_SetSpeed(1,0);//4轮
	Motor4_SetSpeed(1,value);//3轮
}
